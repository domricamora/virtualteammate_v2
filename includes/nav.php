...
<nav class="nav" aria-label="Primary">
  ...
  <div class="nav-links" id="primaryNav">
    ...
    <div class="nav-drop">
      <a role="button" tabindex="0" class="nav-drop-trigger" aria-haspopup="true" aria-expanded="false">
        Business
        <i class="fa-solid fa-chevron-down nav-caret" aria-hidden="true"></i>
      </a>
      <div class="nav-mega" role="menu" aria-label="Business &amp; non-profit virtual assistants">
        <div class="nav-mega-col">
          ...
          <a class="nav-mega-link" role="menuitem" tabindex="0">
        ...
        <div class="nav-mega-foot">
          ...
          <a role="button" tabindex="0" class="nav-mega-foot-btn">Explore all business roles <i class="fa-solid fa-arrow-right"></i></a>
          <div class="cta-note"><i class="fa-solid fa-shield-halved"></i> Covered by our 30-Day Right-Fit Promise: free replacement or your money back.</div>
        </div>
      </div>
    </div>
