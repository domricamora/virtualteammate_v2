...
<div class="topbar" role="complementary">
  ...
  &nbsp;&bull;&nbsp;
  <a href="<?= $home_base ?>#cta-strategy-call" data-cta-intent="strategy-call">Request My Practice Growth Review <i class="fa-solid fa-arrow-right" style="font-size:11px;" aria-hidden="true"></i></a>
</div>
...
<nav class="nav" aria-label="Primary">
    ...
    <div class="nav-drop">
      ...
      <div class="nav-mega" role="menu" aria-label="Healthcare services">
        ...
        <div class="nav-mega-foot">
          ...
          <a href="<?= $home_base ?>#cta-strategy-call" class="nav-mega-foot-btn" data-cta-intent="strategy-call">Request My Practice Growth Review <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="nav-right">
    ...
    <a href="<?= $home_base ?>#cta-strategy-call" data-cta-intent="strategy-call" class="btn-nav">Request My Practice Growth Review</a>
  </div>
</nav>
