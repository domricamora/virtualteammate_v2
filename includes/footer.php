...
<footer class="footer" role="contentinfo">
  <div class="ft-grid">
    <div>
      ...
      <span class="hipaa-badge hipaa-badge--footer" title="HIPAA-certified virtual assistants"><img class="hipaa-badge-logo" src="<?= $home_base ?>images/hipaa-certified.webp" alt="" aria-hidden="true" width="16" height="16"> HIPAA Certified</span>
  ...
  <div class="ft-bottom">
    <div class="ft-copy">&copy; <?= date('Y') ?> Virtual Teammate &middot; <a href="<?= $home_base ?>terms/">Terms</a> &amp; <a href="<?= $home_base ?>privacy-policy/">Privacy Policy</a> &middot; <a href="/portal/" class="ft-portal-link"><i class="fa-solid fa-lock" aria-hidden="true"></i> Portal Login</a></div>
