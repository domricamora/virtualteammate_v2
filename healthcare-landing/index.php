...
<main>
  ...
  <section class="sec" id="proof" aria-labelledby="proof-h">
    <div class="reveal" style="text-align:center;">
      ...
      <p class="sec-sub" style="max-width:720px;margin:0 auto;">No projections, no spin &mdash; results our virtual teammates delivered against the targets that matter most to a practice.</p>
    </div>
  ...
  <section class="sec" id="pain">
    <div class="hcq-pain reveal">
      ...
      <div class="hcq-pain-grid">
        ...
        <div class="hcq-pain-item"><i class="fa-solid fa-phone-slash"></i><span><strong>Missed follow-ups</strong> that let patients &mdash; and revenue &mdash; slip away.</span></div>
        ...
        <div class="hcq-pain-item"><i class="fa-solid fa-inbox"></i><span><strong>A front desk underwater</strong> on calls, intake and inbox &mdash; every single day.</span></div>
      </div>
      <p class="hcq-pain-close">A HIPAA-certified Virtual Teammate takes it off your plate &mdash; and the quiz below puts a number on exactly what it&rsquo;s costing you now.</p>
    </div>
  </section>
  ...
  <section class="sec" id="offer" aria-labelledby="offer-h">
    ...
    <div class="offer-grid reveal d1">
      ...
      <div class="offer-item"><span class="ico-circle"><i class="fa-solid fa-user-shield"></i></span><p><strong>Backup coverage built in</strong> &mdash; a trained backup arranged within hours, at no charge, if your VA is ever out.</p></div>
  ...
  <section class="sec guarantee" id="promise" aria-labelledby="g-h2">
    <div class="g-wrap reveal">
      <div class="g-copy">
        ...
        <p class="sec-sub">Every placement carries the 30-Day Right-Fit Promise, published in writing &mdash; not buried in a sales call.</p>
        <div class="g-cards">
          <div class="g-card">
        ...
        <p class="hcq-g-outcome">For revenue-cycle placements, we can also commit to a <strong>measurable outcome</strong>: improve your first-pass denial rate by an agreed number of points, or recover an agreed dollar amount of aged A/R within 90 days. Miss it and we work for free until we hit it, or refund the last 30 days. The target is set with you during baseline capture &mdash; ask your CSM whether your practice qualifies.</p>
      </div>
    </div>
  </section>
  ...
  <section class="sec" id="faq" style="padding-top:60px;">
    ...
    <div class="faq-grid">
      ...
      <div class="faq-item reveal d2"><div class="faq-q"><i class="fa-solid fa-arrows-rotate"></i> What happens if my VA isn&rsquo;t the right fit?</div><div class="faq-a">Two cases: (1) wrong fit &mdash; we replace them at no cost, re-shortlisting within 5 business days, billing paused until the replacement is live; (2) outsourcing isn&rsquo;t working &mdash; cancel within the first 30 days and we refund every billed day, no clawbacks.</div></div>
