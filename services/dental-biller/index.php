<?php
$page_title       = 'Dental Biller Virtual Assistants | HIPAA-Compliant Dental Billing VAs | Virtual Teammate';
$page_description = 'Hire HIPAA-compliant dental biller virtual assistants. Insurance claims, EOB posting, AR follow-up & PPO/HMO billing in Dentrix & Open Dental. Save up to 73%.';
...
$faqs = [
  ...
  ['q' => 'Is patient data safe?',
   'a' => 'Every dental biller is HIPAA-compliant, background-checked, and signs a BAA-compatible confidentiality agreement before placement.'],
...
<script type="application/ld+json">
{
  ...
  "description":"HIPAA-compliant virtual dental billers handling insurance claim submission, EOB posting, AR follow-up, secondary claims, narratives and patient billing inside Dentrix, Open Dental and Carestream.",
...
<header class="svc-hero">
  ...
  <div class="svc-hero-inner reveal">
    ...
    <div class="svc-eyebrow"><i class="fa-solid fa-tooth"></i> Dental Billing &amp; AR teammates &middot; HIPAA Compliant</div>
    <h1 class="svc-h1">Dental biller <em>virtual</em> assistants</h1>
    <p class="svc-lead">Stop chasing insurance. Our <strong>HIPAA-compliant virtual dental billers</strong> own claim submission, EOB posting, narratives, AR follow-up and patient billing, inside Dentrix, Open Dental and Carestream, at up to <strong>73% less</strong> than a US in-house dental biller.</p>
    <div class="svc-trust">
  ...
  <div class="svc-hero-vis reveal d2" aria-hidden="true">
    ...
    <div class="hv-card">
      <img src="<?= $home_base ?>images/photos/dental/How-Dental-Virtual-Assistants-Improve-Workflow-Efficiency.webp" alt="Virtual dental biller working on insurance claims for dental practice" loading="lazy"/>
    </div>
  </div>
</header>
...
<section class="svc-split">
  <div class="reveal">
    ...
    <ul class="svc-checks">
      ...
      <li><i class="fa-solid fa-check"></i><span><strong>Denial &amp; appeals work:</strong> root-cause review, narrative rewrites, resubmits, payer phone calls.</span></li>
      <li><i class="fa-solid fa-check"></i><span><strong>AR follow-up:</strong> 30/60/90+ aged buckets, payer status calls, secondary claim release.</span></li>
      <li><i class="fa-solid fa-check"></i><span><strong>Pre-authorizations &amp; predeterminations:</strong> submission, tracking, patient-quote handoff.</span></li>
      <li><i class="fa-solid fa-check"></i><span><strong>Patient billing &amp; statements:</strong> balance reconciliation, statements, payment plan setup.</span></li>
    </ul>
  </div>
  <div class="svc-side-img reveal d2">
    <img src="<?= $home_base ?>images/photos/dental/Improve-Practice-Operations-Seamlessly.webp" alt="Dental biller working on insurance claims at desk" loading="lazy"/>
  </div>
</section>
...
<section class="svc-bens">
  ...
  <div class="svc-bens-grid">
    ...
    <div class="svc-ben reveal d3"><span class="ico-circle lg"><i class="fa-solid fa-shield-halved"></i></span><h3>HIPAA &amp; PHI-safe</h3><p>Background-checked, HIPAA-compliant, BAA-compatible. Patient and payer data stays inside approved systems.</p></div>
...
<section class="svc-tools">
  <div class="svc-tools-wrap reveal">
    ...
    <div class="svc-tools-chips">
      ...
      <span class="svc-tool-chip"><i class="fa-solid fa-network-wired"></i> ClaimX / Vyne</span>
      <span class="svc-tool-chip"><i class="fa-solid fa-code"></i> CDT Codes</span>
      <span class="svc-tool-chip"><i class="fa-solid fa-handshake"></i> Delta &middot; MetLife &middot; Aetna</span>
      <span class="svc-tool-chip"><i class="fa-solid fa-handshake"></i> Cigna &middot; United Concordia</span>
    </div>
  </div>
</section>
...
<section class="sec" id="faq" style="padding-top:70px;">
  ...
  <div class="faq-grid">
    ...
    <div class="faq-item reveal d5"><div class="faq-q"><i class="fa-solid fa-shield-halved"></i> Is patient data safe?</div><div class="faq-a">Every dental biller is HIPAA-compliant, background-checked, and signs a BAA-compatible confidentiality agreement before placement.</div></div>
