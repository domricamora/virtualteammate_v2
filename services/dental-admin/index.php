...
<header class="svc-hero">
  ...
  <div class="svc-hero-inner reveal">
    ...
    <div class="svc-cta-row">
      <a href="<?= $home_base ?>#cta" class="btn-primary">Hire a Dental Admin VA <i class="fa-solid fa-arrow-right"></i></a>
  ...
  <div class="svc-hero-vis reveal d2" aria-hidden="true">
    ...
    <div class="hv-card">
      <img src="<?= $home_base ?>images/photos/dental/Administrative-Support-Without-the-Overhead.png" alt="Dental administrative virtual assistant working on a computer" loading="lazy"/>
    </div>
  </div>
</header>
...
<section class="svc-split">
  <div class="reveal">
    ...
    <p class="svc-p">Front-desk teams burn hours on insurance breakdowns, chart prep and data entry that don&rsquo;t need to happen chairside. A dental admin VA absorbs that workload so your in-office team can focus on patients and case acceptance.</p>
    <ul class="svc-checks">
  ...
  <div class="svc-side-img reveal d2">
    <img src="<?= $home_base ?>images/photos/dental/How-Dental-Virtual-Assistants-Improve-Workflow-Efficiency.png" alt="Dental admin VA reviewing records on laptop" loading="lazy"/>
  </div>
</section>
...
<section class="sec" id="faq" style="padding-top:70px;">
  <div class="reveal"><div class="sec-lbl"><i class="fa-solid fa-circle-question"></i> FAQ</div><h2 class="svc-h2">Dental Admin VA FAQs</h2></div>
  <div class="faq-grid">
