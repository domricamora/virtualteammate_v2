...
<header class="svc-hero">
  ...
  <div class="svc-hero-vis reveal d2" aria-hidden="true">
    ...
    <div class="hv-card">
      <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=900&q=85" alt="Virtual medical receptionist answering patient calls"/>
    </div>
  </div>
</header>
...
<section class="svc-split">
  ...
  <div class="svc-side-img reveal d2">
    <img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=900&q=85" alt="Medical receptionist scheduling appointments on computer"/>
  </div>
</section>
...
<section class="svc-proc">
  ...
  <div class="proc-steps">
    <div class="pstep reveal d1"><div class="pstep-head"><div class="pstep-num">01</div><i class="fa-solid fa-calendar-check pstep-ico"></i></div><h3 class="pstep-title">Free Strategy Call</h3><p class="pstep-desc">Map your call volume, phone system, EHR and scheduling rules. Define the exact tasks the receptionist will own.</p></div>
