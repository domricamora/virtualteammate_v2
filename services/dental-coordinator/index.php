...
<header class="svc-hero">
  ...
  <div class="svc-hero-inner reveal">
    ...
    <div class="svc-cta-row">
      <a href="<?= $home_base ?>#cta" class="btn-primary">Hire a Treatment Coordinator <i class="fa-solid fa-arrow-right"></i></a>
  ...
  <div class="svc-hero-vis reveal d2" aria-hidden="true">
    ...
    <div class="hv-card">
      <img src="<?= $home_base ?>images/photos/dental-assistant.jpg" alt="Virtual dental treatment coordinator on a follow-up call"/>
    </div>
  </div>
</header>
...
<section class="svc-split">
  <div class="reveal">
    ...
    <p class="svc-p">The biggest leak in most dental practices isn&rsquo;t marketing &mdash; it&rsquo;s diagnosed treatment that never gets scheduled and patients who fall out of recall. A dedicated treatment coordinator works those lists every single day.</p>
    <ul class="svc-checks">
  ...
  <div class="svc-side-img reveal d2">
    <img src="https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=900&q=85" alt="Dental coordinator reviewing treatment plans"/>
  </div>
</section>
...
<section class="svc-bens">
  <div class="reveal" style="text-align:center;">
    ...
    <p class="sec-sub" style="max-width:700px;margin:0 auto;">A dedicated person whose entire job is converting diagnosed treatment and protecting recall &mdash; without adding an in-office salary.</p>
  </div>
...
<section class="svc-proc">
  ...
  <div class="proc-steps">
    <div class="pstep reveal d1"><div class="pstep-head"><div class="pstep-num">01</div><i class="fa-solid fa-calendar-check pstep-ico"></i></div><h3 class="pstep-title">Free Strategy Call</h3><p class="pstep-desc">Review your unscheduled-treatment report, recall numbers, PMS and financing options.</p></div>
