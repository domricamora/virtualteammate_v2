...
<header class="svc-hero">
  ...
  <div class="svc-hero-vis reveal d2" aria-hidden="true">
    ...
    <div class="hv-card">
      <img src="<?= $home_base ?>images/photos/dental/Improve-Practice-Operations-Seamlessly.png" alt="Virtual dental receptionist answering patient calls" loading="lazy"/>
    </div>
  </div>
</header>
...
<section class="svc-split">
  ...
  <div class="svc-side-img reveal d2">
    <img src="<?= $home_base ?>images/photos/dental/Administrative-Support-Without-the-Overhead.png" alt="Dental receptionist scheduling appointments on a computer" loading="lazy"/>
  </div>
</section>
...
<section class="svc-proc">
  ...
  <div class="proc-steps">
    <div class="pstep reveal d1"><div class="pstep-head"><div class="pstep-num">01</div><i class="fa-solid fa-calendar-check pstep-ico"></i></div><h3 class="pstep-title">Free Strategy Call</h3><p class="pstep-desc">Map your call volume, phone system, PMS and scheduling rules. Define the exact tasks the receptionist owns.</p></div>
