...
<section class="sec" id="faq" style="padding-top:70px;">
  ...
  <div class="faq-grid">
    ...
    <div class="faq-item reveal d6"><div class="faq-q"><i class="fa-solid fa-user-tie"></i> What happens if my scribe is sick?</div><div class="faq-a">Trained backup coverage is included &mdash; your Client Success Manager (CSM) arranges a substitute scribe so you&rsquo;re never charting alone again.</div></div>
  </div>
</section>
