<?php
$page_title       = 'Medical Assistant Virtual Assistants | HIPAA-Compliant Virtual MAs | Virtual Teammate';
$page_description = 'Hire HIPAA-compliant virtual medical assistants. Patient triage prep, EHR workflows, prior auth, refill management & care coordination. Save up to 73% vs in-house MAs.';
...
<script type="application/ld+json">
{
  ...
  "description":"HIPAA-compliant virtual medical assistants supporting clinical teams with triage prep, refill management, prior authorization, EHR follow-up, care coordination and patient education.",
...
<section class="svc-bens">
  ...
  <div class="svc-bens-grid">
    ...
    <div class="svc-ben reveal d4"><span class="ico-circle lg"><i class="fa-solid fa-shield-halved"></i></span><h3>HIPAA &amp; PHI-safe</h3><p>Background-checked, HIPAA-compliant, BAA-compatible. Encrypted environments only.</p></div>
...
<section class="svc-proc">
  ...
  <div class="proc-steps">
    ...
    <div class="pstep reveal d2"><div class="pstep-head"><div class="pstep-num">02</div><i class="fa-solid fa-users-viewfinder pstep-ico"></i></div><h3 class="pstep-title">Shortlist &amp; interview</h3><p class="pstep-desc">Curated shortlist of HIPAA-compliant virtual MAs matched to your specialty and EHR. You interview, you choose.</p></div>
